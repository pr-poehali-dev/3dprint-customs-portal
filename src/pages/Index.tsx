      ...
      <section id="calculator" className="py-20 px-4 bg-gradient-to-br from-gray-50 to-purple-50">
        <div className="container mx-auto max-w-2xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Заполните форму и получите предварительный расчет</p>
          </div>
          <Card className="border-2">
            <CardHeader>
              <CardTitle className="text-2xl">Заявка на расчет</CardTitle>
            ...
            <CardContent>
              <form onSubmit={handleFormSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label>Можно приложить файл 3D-модели на почту:</Label>
                  <p className="text-sm text-gray-600">info@3dprintcustoms.ru</p>
                </div>
